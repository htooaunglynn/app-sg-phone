...
class UploadController {
  ...
  isValidFilename(filename) {
    ...
    // Check for valid filename patterns (timestamp_name_hash.ext) - Excel only
    const validExcelPattern = /^[\d\-T:]+_[a-zA-Z0-9_\-]+_[a-f0-9]{8}\.(xlsx|xls)$/;

    return validExcelPattern.test(filename);
  }
